...
.toc a{text-decoration:none;color:var(--doc-ink);background:var(--doc-chip);
  border:1px solid var(--doc-rule);border-radius:999px;padding:6px 14px;font-size:13px;transition:.15s}
...
/* ---------- contrast table ---------- */
.ctab{width:100%;border-collapse:collapse;margin:16px 0 0;font-size:13.5px}
...
.sg-d label{display:block;font-family:'Cinzel',Georgia,serif;font-size:10.5px;letter-spacing:.28em;
...
.sg-l h3{font-family:'Cinzel',Georgia,serif;font-weight:400;font-size:11px;letter-spacing:.26em;
  text-transform:uppercase;color:#7E6329;margin:0;padding-bottom:12px;border-bottom:1px solid #DED5C6}
...
.sg-l .pmeta{font-family:'Cinzel',Georgia,serif;font-size:10.5px;letter-spacing:.24em;
...
<div class="panel">
  ...
  <div class="stage light sg-l specstack">
    ...
    <div><h3 style="max-width:420px">What&rsquo;s inside</h3><p class="caption">h3 — Cinzel 400, 11px, tracking .26em, #7E6329, rule beneath</p></div>
    <div><p class="kicker">The Workbook</p><p class="caption">.kicker — Cinzel 11px, tracking .3em, #7E6329</p></div>
    <div><p class="pmeta">Print edition &middot; 52 mantras &middot; Twelve themes</p><p class="caption">.pmeta — Cinzel 10.5px, tracking .24em, #5E5548</p></div>
...
<div class="panel">
  ...
  <div class="stage dark sg-d">
    <div class="specrow">
      <a class="btn" href="#buttons">Send Inquiry</a>
      <a class="btn btn-ghost" href="#buttons">The Workbook</a>
    </div>
...
<div class="panel">
  ...
  <div class="stage dark sg-d">
    ...
    <p class="caption">label — Cinzel 10.5px, tracking .28em, #D4B87A<br>
